...
<head>
  ...
  <title>FoodMathLab | Blank Page</title>
  <!-- Icono -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link text-red"><i class="fas fa-house-user"></i> Inicio</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" role="button" title="Salir">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://www.nutrimonitor.com/" target="_blank">Nutrimotor</a>.</strong> Todos los derechos reservados
  </footer>
